...
class OffboardControl(Node):
    ...
    def initialize_parameters(self):
        ...
        self.takeoff_height = 0.7  # meters
        self.takeoff_completed = False
        self.takeoff_tolerance = 0.2  # effectively 0.5m
    ...
    def publish_offboard_control_heartbeat_signal(self, positionMode = True):
        """Publish the offboard control mode."""
        msg = OffboardControlMode()
        msg.position = positionMode
        msg.velocity = not positionMode
    ...
    def timer_callback(self) -> None:
        ...
        _positionMode = True
        self.publish_offboard_control_heartbeat_signal(positionMode=_positionMode)
        ...
        match self.current_state:
            ...
            case "ARMING":
                if(not(self.flightCheck)):
                    ...
                    self.get_logger().info("Armed → Switching to Takeoff")
                self.arm()
            ...
            case "LOITER": 
                if(not(self.flightCheck)):
                    ...
                    # or abs(current_z - target_z) < self.takeoff_tolerance
