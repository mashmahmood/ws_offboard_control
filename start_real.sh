...
"ssh -t firedrone@10.42.0.1 'bash -i -c \"source /opt/ros/humble/setup.bash && source ~/ws_offboard_control/install/setup.bash && ros2 launch px4_ros_com offboard_control_drone.launch.py\"'" C-m
